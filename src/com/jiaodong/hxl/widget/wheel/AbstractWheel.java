...
package com.jiaodong.hxl.widget.wheel;
...
import com.jiaodong.hxl.widget.wheel.adapter.WheelViewAdapter;
	...
	protected void initData(Context context) {
		...
		mScroller = createScroller(new WheelScroller.ScrollingListener() {
			...
			public void onScroll(int distance) {
				if ((mCurrentItemIdx == 0) && (distance > 0)) {
					mScrollingOffset = 0;
					mScroller.stopScrolling();
				} else if ((mCurrentItemIdx == mViewAdapter.getItemsCount() - 1)&&(distance < 0)){
					mScrollingOffset = 0;
					mScroller.stopScrolling();
				} else {
					doScroll(distance);
